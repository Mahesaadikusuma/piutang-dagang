    ...
    <header class="w-full pt-[74px] pb-[103px] relative z-0">
        <div class="container max-w-[1130px] mx-auto flex flex-col items-center justify-center z-10">
            <div class="flex flex-col gap-4 mt-7 z-10">
                ...
                <h1 class="font-semibold text-2xl lg:text-5xl">Huis Elite: The Complete Smart Home App UI Kit for
                    Modern Living
                </h1>
            </div>
        </div>
        <div class="background-image w-full h-full absolute top-0 overflow-hidden z-0">
            <img src="{{ asset('assets/images/backgrounds/hero.png') }}" class="w-full h-full object-cover"
                alt="hero image">
        </div>
    ...
    <section id="DetailsContent" class="container max-w-[1130px] mx-auto mb-[32px] relative -top-[70px]">
        <div class="flex flex-col gap-8">
            <div class="w-full h-[400px] sm:h-[500px] md:h-[700px] flex shrink-0 rounded-[20px] overflow-hidden">
                <img src="{{ asset('assets/images/backgrounds/hero.png') }}"
                    class="w-full h-full object-cover bg-center" alt="hero image">
            </div>
            <div class="flex flex-col gap-8 lg:flex-row sm:gap-8 relative -mt-[93px]">
                <div
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <p class="text-belibang-grey leading-[30px] text-justify">Introducing our cutting-edge UI/UX
                            template,
