<div>
    <button type="button" data-tooltip-target="tooltip-default-{{ $permission->id }}" wire:click="openModal"
        class="flex items-center justify-center text-cyan-500 hover:text-cyan-700 font-bold">
        Edit
    </button>

    <div id="tooltip-default-{{ $permission->id }}" role="tooltip"
    ...
    <x-modal wire:model="showModal">
        ...
        <form wire:submit.prevent="update">
            <div class="p-4 md:p-5 space-y-4">
                <h1 class="text-gray-800 font-bold text-xl">Update Permission</h1>
                <div class="mb-5">
