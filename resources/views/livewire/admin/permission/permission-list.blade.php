                ...
                <tr class="border-b dark:border-gray-700">
                    ...
                    <td>
                        <div wire:ignore class="flex gap-3 items-center">
                            <livewire:admin.permission.permission-edit :permission="$permission" :key="$permission->id" />
                            <livewire:admin.permission.permission-delete :permission="$permission" :key="$permission->id" />
                        </div>
                    </td>
                </tr>
            @empty
                <tr class="border-b dark:border-gray-700">
                    <td colspan="{{ count($heads) }}" class="px-4 py-10 text-center">
                        <div class="flex flex-col justify-center items-center h-full">
                            <p class="text-gray-500 dark:text-gray-400 text-lg font-medium">No Permission found
                            </p>
                        </div>
                    </td>
                </tr>
