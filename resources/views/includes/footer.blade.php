<footer class="bg-[#181818] py-[34px]">
    <div class="container max-w-[1130px] mx-auto flex flex-col gap-[66px]">
        <div class="flex flex-col lg:flex-row justify-between">
            ...
            <!-- Right sections -->
            <div class="flex flex-wrap gap-[72px] justify-between lg:w-3/4">
                <!-- Browse -->
                <div class="flex flex-col gap-8 w-full sm:w-1/2 lg:w-auto">
        ...
        <!-- Footer Bottom -->
        <p class="text-[10px] text-[#595959] text-center sm:text-left">© 2024, Belibang LLC.</p>
    </div>
</footer>
